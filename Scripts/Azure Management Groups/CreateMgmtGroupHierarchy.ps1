...
# Level-2 Decomissioned Management Group
$retired = "Decomissioned"
...
## Create Level-2 Sandbox and Decomissioned Management Groups

New-AzManagementGroup -GroupName $sandboxManagementGroupGuid -DisplayName $sandboxManagementGroupName -ParentObject $ManagementParentGroup
New-AzManagementGroup -GroupName $retiredManagementGroupGuid -DisplayName $retiredManagementGroupName -ParentObject $ManagementParentGroup

Write-Host ($writeEmptyLine + "*****Level-2 Sandbox and Decomissioned Management Groups created*****") -foregroundcolor $foregroundColor1 $writeEmptyLine
